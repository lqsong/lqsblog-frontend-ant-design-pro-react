...
const ArticleHitCard: React.FC<ArticleHitCardProps> = () => {
    ...
    const columns: ColumnsType<TableListItem> = [
        {
            title: intl.formatMessage({id: 'app.home.articlehitcard.card.table-column-number'}),
            dataIndex: 'index',
            width: 80,
        ...
        {
            title: intl.formatMessage({id: 'app.home.articlehitcard.card.table-column-title'}),
            dataIndex: 'title',
        },
        {
            title: intl.formatMessage({id: 'app.home.articlehitcard.card.table-column-hit'}),
            dataIndex: 'hit',
        },
    ];

    return (
        <Card className={styles.homeBoxCard} title={intl.formatMessage({id: 'app.home.articlehitcard.card-title'})}>
            <Table
              size="small"
              rowKey="id"
              columns={columns}
